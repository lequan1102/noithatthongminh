        ...
        <form action="{{ route('submit.create.location.user') }}" method="POST" class="add-location">
            ...
            <div class="row" style="padding: 30px">
                <div class="col col-md-6 col-12">
                    <label for="">
                        <span>Tên</span>
                        <input value="{{ $location->full_name }}" type="text" placeholder="Họ tên" name="full_name" required>
                    </label>
                </div>
                <div class="col col-md-6 col-12">
                    <label for="">
                        <span>Số điện thoại</span>
                        <input value="{{ $location->number_phone }}" type="text" placeholder="Vui lòng điền số điện thoại của bạn" name="number_phone" required>
                    </label>
                </div>
                <div class="col col-md-6 col-12">
                    <label for="">
                        <span>Địa chỉ nhận hàng</span>
                        <input value="{{ $location->location }}" type="text" placeholder="Vui lòng chọn địa chỉ của bạn vd: số nhà.." name="location" required>
                    </label>
                </div>
                <div class="col col-md-6 col-12">
                    <label for="thanhpho">
                ...
                <div class="col col-md-6 col-12">
                    <label for="">
                        ...
                        <select class="location" name="wards" id="ward" style="width: 100%; border: 1px solid #ececec" required>
                            @if ($location->wards != '')
                                <option value="{{ $location->wards }}">{{ $location->wards }}</option>
                                @else
                ...
                <div class="col col-md-6 col-12">
                    <div class="location-default mt30">
                        <label for="default">
                            <input type="checkbox" name="default" id="default" <?php if($location->default != null) echo 'checked' ?>>
