    ...
    <div class="col col-md-9 col-12" style="margin-bottom: 30px">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @endif
                Bạn đã đăng nhập trong khách hàng!
            </div>
        </div>
    </div>
@endsection