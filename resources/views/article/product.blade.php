    ...
    <div class="container product-article">
        <div class="row">
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb" style="padding-left: 0px; margin-bottom: 0px">
                      <li class="breadcrumb-item"><a href="{{ asset('') }}">Trang chủ</a></li>
                      <li class="breadcrumb-item"><a href="{{ route('cate.product') }}">Sản phẩm</a></li>
        ...
        <div class="row">
            ...
            <div class="col col-md-4 col-12 excerpt">
                ...
                <div class="product-cart-info" id="fixed-cart-mb">
                    <div class="quantity">
                    ...
                    <a href="javascript:void(0)" onclick="add_cart(this)" data-product-id="{{$article->id}}" class="add-cart">Thêm giỏ hàng</a>
                    <span class="favorite" onclick="add_favorite(this)"  data-product-id="{{$article->id}}" title="Yêu thích">
