...
    | ------------------------------------------------- -------------------------
    |
    | Tại đây bạn có thể sửa đổi một số khía cạnh của bảng điều khiển của bạn
    |
    */

    'dashboard' => [
        // Thêm các mục danh sách tùy chỉnh vào danh sách thả xuống của thanh điều hướng
        'navbar_items' => [
    ...
    */
    ...
    'additional_js' => [
         ...
         '/public/form_fields/jquery.masknumber.min.js',
         '/public/form_fields/javascript.js',
    ],
    ...
    */
    ...
    'settings' => [
        // Cho phép phương thức bộ đệm của Laravel cho lưu trữ giá trị bộ đệm giữa các yêu cầu
        'cache' => true,
    ],

    //Kích hoạt la bàn khi môi trường KHÔNG cục bộ
